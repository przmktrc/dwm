...
static const char *fonts[]          = { "UbuntuMono Nerd Font:size=12", "monospace:size=10", "Liberation Mono:size=12" };
...
static const char* volume_up_cmd[] = { "amixer", "sset", "Master", "5%+", NULL };
static const char* volume_down_cmd[] = { "amixer", "sset", "Master", "5%-", NULL };
static const char* volume_mute_cmd[] = { "amixer", "sset", "Master", "toggle", NULL };
static const char* mic_mute_cmd[]    = { "amixer", "sset", "Capture", "toggle", NULL };
